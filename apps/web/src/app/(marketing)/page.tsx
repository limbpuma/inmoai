            ...
            <main className="flex-1">
                ...
                <section className="relative overflow-hidden py-24 lg:py-32">
                    ...
                    <div className="container px-4 md:px-6 mx-auto flex flex-col items-center text-center space-y-8">
                        <Badge variant="outline" className="px-4 py-1.5 text-sm rounded-full border-ai/30 bg-ai/10 text-ai animate-in fade-in zoom-in duration-500">
                        ...
                        <h1 className="heading-hero text-4xl sm:text-5xl md:text-6xl lg:text-7xl max-w-5xl mx-auto bg-clip-text text-transparent bg-gradient-to-br from-foreground to-foreground/70 dark:from-white dark:to-white/70">
                            Encuentra tu hogar con <span className="text-ai">inteligencia</span>
                        </h1>
                    ...
                    <div className="container px-4 md:px-6 mx-auto">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                            <div className="flex flex-col space-y-4 p-6 rounded-2xl bg-background border border-border/50 shadow-sm hover:shadow-md transition-shadow cursor-pointer">
                                ...
                                <h3 className="heading-section text-xl">Búsqueda Semántica</h3>
                            ...
                            <div className="flex flex-col space-y-4 p-6 rounded-2xl bg-background border border-border/50 shadow-sm hover:shadow-md transition-shadow cursor-pointer">
                                ...
                                <h3 className="heading-section text-xl">Verificación Anti-Fraude</h3>
                                <p className="text-muted-foreground leading-relaxed">
                            ...
                            <div className="flex flex-col space-y-4 p-6 rounded-2xl bg-background border border-border/50 shadow-sm hover:shadow-md transition-shadow cursor-pointer">
                                ...
                                <h3 className="heading-section text-xl">Análisis de Mercado</h3>
                                <p className="text-muted-foreground leading-relaxed">
